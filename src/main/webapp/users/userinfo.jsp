							...
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF">${sessionScope.users.username }<input type="hidden"
										...
										type="hidden" name="usersid" style="width: 160px" id="usersid" value="${sessionScope.users.usersid }" /><input
										type="hidden" name="regdate" style="width: 160px" id="regdate" value="${sessionScope.users.regdate }" />
									</td>
								</tr>
								<tr>
								...
								<tr>
									...
									<td width="76%" align="left" bgcolor="#FFFFFF"><input name="idcard" type="text" size="25" class="inputBg"
										id="idcard" value="${sessionScope.users.idcard }" /></td>
								</tr>
								<tr>
