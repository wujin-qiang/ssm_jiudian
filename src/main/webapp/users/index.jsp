		...
		<div class="goodsBox_1">
			...
			<div class="xm-box">
				<div class="title">
					...
					<h2>酒店房间</h2>
					<a class="more" href="index/rooms.action">更多 </a>
				</div>
				<div id="show_new_area" class="clearfix xm-boxs">
					...
					<c:forEach items="${roomsList}" var="rooms">
						<div class="goodsItem goodsItems">
							...
							<p class="">
								费用： <font class="f1">￥${rooms.price }元</font>
							</p>
						</div>
					</c:forEach>
					<!-- 循环结束  -->
			...
			<div class="xm-box">
				<div class="title">
					<span class="floor-icon"><i></i><b></b> </span>
					<h2>酒店餐饮</h2>
					<a class="more" href="index/foods.action">更多 </a>
				</div>
				<div id="show_new_area" class="clearfix xm-boxs">
					<!-- 循环开始  -->
					<c:forEach items="${foodsList}" var="foods">
						<div class="goodsItem goodsItems">
							<a href="index/foodsdetail.action?id=${foods.foodsid }"><img src="${foods.image }" alt="${foods.foodsname }"
								class="goodsimg" /> </a> <br />
							<p class="f1">
								<a href="index/foodsdetail.action?id=${foods.foodsid }" title="${foods.foodsname }">${foods.foodsname }</a>
							</p>
							<p class="">
								价格： <font class="f1"> ￥${foods.price }元</font>
							</p>
						</div>
					</c:forEach>
					<!-- 循环结束  -->
