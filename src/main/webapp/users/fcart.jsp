					...
					<c:forEach items="${cartList}" var="cart">
						<tr>
							<td bgcolor="#ffffff" align="center" style="width: 300px;"><a
								href="index/foodsdetail.action?id=${cart.foodsid }" target="_blank"><img style="width: 80px; height: 80px;"
									src="${cart.image }" border="0" title="${cart.foodsname }" /> </a> <br /> <a
								href="index/foodsdetail.action?id=${cart.foodsid }" target="_blank" class="f6">${cart.foodsname }</a></td>
							...
							<td align="center" bgcolor="#ffffff"><a
								href="javascript:if (confirm('您确实要移出餐饮预订吗？')) location.href='<%=basePath%>index/deletefcart.action?id=${cart.fcartid}'; "
								class="f6">移除</a></td>
						</tr>
					</c:forEach>
				</table>
				<table width="99%" align="center" border="0" cellpadding="5" cellspacing="0" bgcolor="#dddddd">
					<tr>
						<td bgcolor="#ffffff"><a href="index.jsp"><img src="themes/xecmoban_haier2015/images/continue.gif"
								alt="continue" /> </a></td>
						<td bgcolor="#ffffff" align="right"><a href="index/fcheckout.action"><img
