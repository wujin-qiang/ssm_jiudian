...
<body class=" theme-blue">
	...
	<div class="content">
		<div class="header">
			<h1 class="page-title">编辑客房类型信息</h1>
		</div>
						...
						<form action="cate/updateCate.action" name="myform" method="post" onsubmit="return check()" class="form">
							...
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>类型名称</label> <input type="text" name="catename" class="form-control" id="catename"
										value="${cate.catename}" />
								</div>
							</div>
							<div class="tab-pane active in" id="home">
								<div class="form-group">
									<label>备注</label> <input type="text" name="memo" class="form-control" id="memo" value="${cate.memo}" />
								</div>
							</div>
							<div>
								<input type="hidden" name="cateid" id="cateid" value="${cate.cateid}" />
