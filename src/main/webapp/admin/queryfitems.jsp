		...
		<div class="main-content">
			<table class="table">
				...
				<c:forEach items="${fitemsList}" var="fitems">
					<tr align="center">
						<td class="center">${fitems.ordercode}</td>
						<td class="center">${fitems.foodsname}</td>
						<td class="center">${fitems.num}</td>
						<td class="center">${fitems.price}</td>
					</tr>
				</c:forEach>
			</table>
			<ul class="pagination">
				<li>
					<form action="fitems/queryFitemsByCond.action" name="myform" method="post">
						<label>查询条件: <select name="cond" style="width: 100px">
								<option value="ordercode">按订单号查询</option>
								<option value="foodsid">按食品查询</option>
