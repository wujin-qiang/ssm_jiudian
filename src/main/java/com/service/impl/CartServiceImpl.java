...
public class CartServiceImpl implements CartService {
	...
	@Override // 继承接口的按条件精确查询
	public List<Cart> getCartByCondIsUse(Cart cart) {
		return this.cartDAO.getCartByCondIsUse(cart);
	}
	...
	@Override // 继承接口的更新 返回值0(失败),1(成功)
	public int updateCartType(Cart cart) {
		return this.cartDAO.updateCartType(cart);
	}
}
